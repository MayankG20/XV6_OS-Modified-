...
int main(int argc,char *argv[]){
  ...
  42:	83 c4 10             	add    $0x10,%esp
	...
	exit();
  45:	e8 98 02 00 00       	call   2e2 <exit>
		int x=set_priority(a,b);
  4a:	52                   	push   %edx
  4b:	52                   	push   %edx
  4c:	50                   	push   %eax
  4d:	57                   	push   %edi
  4e:	e8 37 03 00 00       	call   38a <set_priority>
		if(x==-1){
  53:	83 c4 10             	add    $0x10,%esp
  56:	83 f8 ff             	cmp    $0xffffffff,%eax
  59:	74 13                	je     6e <main+0x6e>
		printf(1,"Priority of Process with pid %d was this %d previously\n",a,x);
  5b:	50                   	push   %eax
  5c:	57                   	push   %edi
...
printf(int fd, const char *fmt, ...)
{
 ...
 5f4:	e9 8f fe ff ff       	jmp    488 <printf+0x48>
          s = "(null)";
 5f9:	bb 08 08 00 00       	mov    $0x808,%ebx
        while(*s != 0){
 ...
 611:	a1 c0 0a 00 00       	mov    0xac0,%eax
{
 ...
 64d:	89 08                	mov    %ecx,(%eax)
  freep = p;
 64f:	a3 c0 0a 00 00       	mov    %eax,0xac0
}
 654:	5b                   	pop    %ebx
 655:	5e                   	pop    %esi
 656:	5f                   	pop    %edi
...
malloc(uint nbytes)
{
 ...
 6ef:	73 47                	jae    738 <malloc+0x98>
    ...
    if(p == freep)
 6f1:	39 05 c0 0a 00 00    	cmp    %eax,0xac0
 ...
 716:	e8 f5 fe ff ff       	call   610 <free>
  return freep;
 71b:	8b 15 c0 0a 00 00    	mov    0xac0,%edx
 ...
 744:	89 78 04             	mov    %edi,0x4(%eax)
      freep = prevp;
 747:	89 15 c0 0a 00 00    	mov    %edx,0xac0
}
 ...
 767:	0a 00 00 
 76a:	c7 05 c4 0a 00 00 c4 	movl   $0xac4,0xac4
 771:	0a 00 00 
    base.s.size = 0;
 774:	b8 c4 0a 00 00       	mov    $0xac4,%eax
