...
int main (int argc,char *argv[])
{
  ...
  2a:	e8 db 02 00 00       	call   30a <exec>
  ...
  4e:	68 98 07 00 00       	push   $0x798
  53:	6a 01                	push   $0x1
  55:	e8 d6 03 00 00       	call   430 <printf>
 	exit();
  5a:	83 c4 20             	add    $0x20,%esp
  5d:	e8 70 02 00 00       	call   2d2 <exit>
    	status = waitx(&a, &b);
  62:	50                   	push   %eax
  63:	50                   	push   %eax
  64:	8d 45 e4             	lea    -0x1c(%ebp),%eax
  67:	50                   	push   %eax
  68:	8d 45 e0             	lea    -0x20(%ebp),%eax
  6b:	50                   	push   %eax
  6c:	e8 01 03 00 00       	call   372 <waitx>
  71:	83 c4 10             	add    $0x10,%esp
  74:	89 c3                	mov    %eax,%ebx
  76:	eb cc                	jmp    44 <main+0x44>
  78:	66 90                	xchg   %ax,%ax
  7a:	66 90                	xchg   %ax,%ax
  7c:	66 90                	xchg   %ax,%ax
  7e:	66 90                	xchg   %ax,%ax
